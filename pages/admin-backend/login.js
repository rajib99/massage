...
const Login = (location) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://api.tsm.cc/v1/admin-backend/login.php', { email, password });
...
//         axios.post('https://api.tsm.cc/v1/admin-backend/login.php', {
//             firstName: 'Fred',
//             lastName: 'Flintstone'
//           })
...
// //     try {
// //       const response = await fetch("https://api.tsm.cc/v1/admin-backend/login.php", {
// //         method: "POST",
// //         headers: {
