...
function Booking() {
    ...
    const getcardEndingwith = () => {
      ...
      // try {
      //   const response = await axios.get('https://api.tsm.cc/v1/cardendwith.php?customerid=' + customerId);
    ...
    const confirmorder = async (e) => {
      ...
      try {
        ...
        const response = await axios.post('https://api.tsm.cc/v1/confirmorder.php', orderData);
    ...
    const handleLogin = async (e) => {
      e.preventDefault();
      try {
        const response = await axios.post('https://api.tsm.cc/v1/login-customer.php', formData);
    ...
    const handleCustomerRegistration = async (e) => {
      ...
      try {
        ...
        const response = await axios.post('https://api.tsm.cc/v1/register-customer.php', formData);
  ...
  const goPrevDay = (dstring) => {
   ...
   const updateAvailTime = async (modId, cdate) => {
    ...
    try {
      ...
      const response = await axios.get('https://api.tsm.cc/v1/availability.php?modelid='+ modId + '&date=' + cdated);

      console.log('availdata','https://api.tsm.cc/v1/availability.php?modelid='+ modId + '&date=' + cdated, response.data);
